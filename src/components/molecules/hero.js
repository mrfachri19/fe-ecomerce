    ...
    <section className="hero">
      <div className="container">
        <div className="hero__content">
          <h1>
            Start Your Day with
            <span className="d-md-block"> Shopping in Cloth Store </span>
          </h1>
          <p>
            We provide high quality Cloth, good Quality, and cheap
            <span className="d-md-block">
              cloth made by love just for you. Start your day with us
            </span>
            for a bigger smile!
          </p>
