  ...
  return (
    <>
      <div className="menu-header d-flex justify-content-between p-4">
        ...
        <div
          className={`food-category-list${
            active === "Minuman" ? " selected-category" : ""
          }`}
        ...
        <div
          className={`food-category-list${
            active === "Snack" ? " selected-category" : ""
          }`}
        ...
        <div
          className={`food-category-list${
            active === "Peralatan Mandi" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Peralatan Mandi")}
        >
          Peralatan Mandi
        </div>
        <div
        ...
        <div
          className={`food-category-list${
            active === "Peralatan Masak" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Peralatan Masak")}
        >
          Peralatan Masak
        </div>
        <div
          className={`food-category-list${
            active === "Peralatan Kerja" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Peralatan Kerja")}
        >
          Peralatan Kerja
        </div>
      </div>
